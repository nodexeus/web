...
export const ProtocolServiceGetStatsResponse: MessageFns<ProtocolServiceGetStatsResponse> = {
  encode(message: ProtocolServiceGetStatsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.protocolStats).forEach(([key, value]: [string, NodeStats]) => {
      ProtocolServiceGetStatsResponse_ProtocolStatsEntry.encode({ key: key as any, value }, writer.uint32(10).fork())
        .join();
    });
    globalThis.Object.entries(message.versionStats).forEach(([key, value]: [string, NodeStats]) => {
  ...
  fromPartial(object: DeepPartial<ProtocolServiceGetStatsResponse>): ProtocolServiceGetStatsResponse {
    const message = createBaseProtocolServiceGetStatsResponse();
    message.protocolStats = (globalThis.Object.entries(object.protocolStats ?? {}) as [string, NodeStats][]).reduce(
      (acc: { [key: string]: NodeStats }, [key, value]: [string, NodeStats]) => {
        if (value !== undefined) {
    ...
    message.versionStats = (globalThis.Object.entries(object.versionStats ?? {}) as [string, NodeStats][]).reduce(
      (acc: { [key: string]: NodeStats }, [key, value]: [string, NodeStats]) => {
        if (value !== undefined) {
          acc[key] = NodeStats.fromPartial(value);
        }
...
export const ProtocolServiceDefinition = {
  ...
  methods: {
    ...
    addProtocol: {
      name: "AddProtocol",
      requestType: ProtocolServiceAddProtocolRequest as typeof ProtocolServiceAddProtocolRequest,
      requestStream: false,
      responseType: ProtocolServiceAddProtocolResponse as typeof ProtocolServiceAddProtocolResponse,
    ...
    addVersion: {
      name: "AddVersion",
      requestType: ProtocolServiceAddVersionRequest as typeof ProtocolServiceAddVersionRequest,
      requestStream: false,
      responseType: ProtocolServiceAddVersionResponse as typeof ProtocolServiceAddVersionResponse,
      responseStream: false,
      options: {},
    },
    ...
    getLatest: {
      name: "GetLatest",
      requestType: ProtocolServiceGetLatestRequest as typeof ProtocolServiceGetLatestRequest,
      requestStream: false,
      responseType: ProtocolServiceGetLatestResponse as typeof ProtocolServiceGetLatestResponse,
      responseStream: false,
      options: {},
    },
    ...
    getPricing: {
      name: "GetPricing",
      requestType: ProtocolServiceGetPricingRequest as typeof ProtocolServiceGetPricingRequest,
      requestStream: false,
      responseType: ProtocolServiceGetPricingResponse as typeof ProtocolServiceGetPricingResponse,
      responseStream: false,
      options: {},
    },
    ...
    getProtocol: {
      name: "GetProtocol",
      requestType: ProtocolServiceGetProtocolRequest as typeof ProtocolServiceGetProtocolRequest,
      requestStream: false,
      responseType: ProtocolServiceGetProtocolResponse as typeof ProtocolServiceGetProtocolResponse,
      responseStream: false,
      options: {},
    },
    /** Get stats for some protocol. */
    getStats: {
      name: "GetStats",
      requestType: ProtocolServiceGetStatsRequest as typeof ProtocolServiceGetStatsRequest,
      requestStream: false,
      responseType: ProtocolServiceGetStatsResponse as typeof ProtocolServiceGetStatsResponse,
      responseStream: false,
      options: {},
    },
    ...
    listProtocols: {
      name: "ListProtocols",
      requestType: ProtocolServiceListProtocolsRequest as typeof ProtocolServiceListProtocolsRequest,
      requestStream: false,
      responseType: ProtocolServiceListProtocolsResponse as typeof ProtocolServiceListProtocolsResponse,
      responseStream: false,
      options: {},
    },
    ...
    listVariants: {
      name: "ListVariants",
      requestType: ProtocolServiceListVariantsRequest as typeof ProtocolServiceListVariantsRequest,
      requestStream: false,
      responseType: ProtocolServiceListVariantsResponse as typeof ProtocolServiceListVariantsResponse,
      responseStream: false,
      options: {},
    },
    ...
    listVersions: {
      name: "ListVersions",
      requestType: ProtocolServiceListVersionsRequest as typeof ProtocolServiceListVersionsRequest,
      requestStream: false,
      responseType: ProtocolServiceListVersionsResponse as typeof ProtocolServiceListVersionsResponse,
      responseStream: false,
      options: {},
    },
    ...
    updateProtocol: {
      name: "UpdateProtocol",
      requestType: ProtocolServiceUpdateProtocolRequest as typeof ProtocolServiceUpdateProtocolRequest,
      requestStream: false,
      responseType: ProtocolServiceUpdateProtocolResponse as typeof ProtocolServiceUpdateProtocolResponse,
      responseStream: false,
      options: {},
    },
    ...
    updateVersion: {
      name: "UpdateVersion",
      requestType: ProtocolServiceUpdateVersionRequest as typeof ProtocolServiceUpdateVersionRequest,
      requestStream: false,
      responseType: ProtocolServiceUpdateVersionResponse as typeof ProtocolServiceUpdateVersionResponse,
      responseStream: false,
      options: {},
    },
  },
