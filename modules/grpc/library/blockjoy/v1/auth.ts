...
export const AuthServiceLoginRequest: MessageFns<AuthServiceLoginRequest> = {
  encode(message: AuthServiceLoginRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceLoginRequest {
...
export const AuthServiceLoginResponse: MessageFns<AuthServiceLoginResponse> = {
  encode(message: AuthServiceLoginResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceLoginResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceRefreshRequest: MessageFns<AuthServiceRefreshRequest> = {
  encode(message: AuthServiceRefreshRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== "") {
      writer.uint32(10).string(message.token);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceRefreshRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceRefreshResponse: MessageFns<AuthServiceRefreshResponse> = {
  encode(message: AuthServiceRefreshResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== "") {
      writer.uint32(10).string(message.token);
    }
    if (message.refresh !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceRefreshResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceConfirmRequest: MessageFns<AuthServiceConfirmRequest> = {
  encode(_: AuthServiceConfirmRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceConfirmRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceConfirmResponse: MessageFns<AuthServiceConfirmResponse> = {
  encode(message: AuthServiceConfirmResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.token !== "") {
      writer.uint32(10).string(message.token);
    }
    if (message.refresh !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceConfirmResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceResetPasswordRequest: MessageFns<AuthServiceResetPasswordRequest> = {
  encode(message: AuthServiceResetPasswordRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== "") {
      writer.uint32(10).string(message.email);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceResetPasswordRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceResetPasswordResponse: MessageFns<AuthServiceResetPasswordResponse> = {
  encode(_: AuthServiceResetPasswordResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceResetPasswordResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceUpdatePasswordRequest: MessageFns<AuthServiceUpdatePasswordRequest> = {
  encode(message: AuthServiceUpdatePasswordRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.password !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceUpdatePasswordRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceUpdatePasswordResponse: MessageFns<AuthServiceUpdatePasswordResponse> = {
  encode(_: AuthServiceUpdatePasswordResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceUpdatePasswordResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceUpdateUIPasswordRequest: MessageFns<AuthServiceUpdateUIPasswordRequest> = {
  encode(message: AuthServiceUpdateUIPasswordRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceUpdateUIPasswordRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceUpdateUIPasswordResponse: MessageFns<AuthServiceUpdateUIPasswordResponse> = {
  encode(_: AuthServiceUpdateUIPasswordResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceUpdateUIPasswordResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceListPermissionsRequest: MessageFns<AuthServiceListPermissionsRequest> = {
  encode(message: AuthServiceListPermissionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.orgId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceListPermissionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceListPermissionsResponse: MessageFns<AuthServiceListPermissionsResponse> = {
  encode(message: AuthServiceListPermissionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthServiceListPermissionsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthServiceDefinition = {
  ...
  methods: {
    ...
    login: {
      name: "Login",
      requestType: AuthServiceLoginRequest as typeof AuthServiceLoginRequest,
      requestStream: false,
      responseType: AuthServiceLoginResponse as typeof AuthServiceLoginResponse,
    ...
    refresh: {
      name: "Refresh",
      requestType: AuthServiceRefreshRequest as typeof AuthServiceRefreshRequest,
      requestStream: false,
      responseType: AuthServiceRefreshResponse as typeof AuthServiceRefreshResponse,
      responseStream: false,
      options: {},
    },
    ...
    confirm: {
      name: "Confirm",
      requestType: AuthServiceConfirmRequest as typeof AuthServiceConfirmRequest,
      requestStream: false,
      responseType: AuthServiceConfirmResponse as typeof AuthServiceConfirmResponse,
      responseStream: false,
      options: {},
    },
    ...
    resetPassword: {
      name: "ResetPassword",
      requestType: AuthServiceResetPasswordRequest as typeof AuthServiceResetPasswordRequest,
      requestStream: false,
      responseType: AuthServiceResetPasswordResponse as typeof AuthServiceResetPasswordResponse,
      responseStream: false,
      options: {},
    },
    ...
    updatePassword: {
      name: "UpdatePassword",
      requestType: AuthServiceUpdatePasswordRequest as typeof AuthServiceUpdatePasswordRequest,
      requestStream: false,
      responseType: AuthServiceUpdatePasswordResponse as typeof AuthServiceUpdatePasswordResponse,
      responseStream: false,
      options: {},
    },
    ...
    updateUIPassword: {
      ...
      requestType: AuthServiceUpdateUIPasswordRequest as typeof AuthServiceUpdateUIPasswordRequest,
      requestStream: false,
      responseType: AuthServiceUpdateUIPasswordResponse as typeof AuthServiceUpdateUIPasswordResponse,
      responseStream: false,
      options: {},
    },
    ...
    listPermissions: {
      ...
      requestType: AuthServiceListPermissionsRequest as typeof AuthServiceListPermissionsRequest,
      requestStream: false,
      responseType: AuthServiceListPermissionsResponse as typeof AuthServiceListPermissionsResponse,
      responseStream: false,
      options: {},
    },
  },
