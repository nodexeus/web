...
export const Node: MessageFns<Node> = {
  encode(message: Node, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.config !== undefined) {
      NodeConfig.encode(message.config, writer.uint32(58).fork()).join();
    }
    if (message.orgId !== "") {
    ...
    if (message.versionKey !== undefined) {
      ProtocolVersionKey.encode(message.versionKey, writer.uint32(162).fork()).join();
    }
    ...
    if (message.nodeStatus !== undefined) {
      NodeStatus.encode(message.nodeStatus, writer.uint32(250).fork()).join();
    }
    for (const v of message.jobs) {
      NodeJob.encode(v!, writer.uint32(258).fork()).join();
    }
    for (const v of message.reports) {
      NodeReport.encode(v!, writer.uint32(266).fork()).join();
    }
    if (message.tags !== undefined) {
      Tags.encode(message.tags, writer.uint32(274).fork()).join();
    }
    if (message.createdBy !== undefined) {
      Resource.encode(message.createdBy, writer.uint32(282).fork()).join();
    }
    if (message.createdAt !== undefined) {
      Timestamp.encode(toTimestamp(message.createdAt), writer.uint32(290).fork()).join();
    }
    if (message.updatedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.updatedAt), writer.uint32(298).fork()).join();
    }
    if (message.cost !== undefined) {
      BillingAmount.encode(message.cost, writer.uint32(306).fork()).join();
    }
    for (const v of message.versionMetadata) {
      VersionMetadata.encode(v!, writer.uint32(314).fork()).join();
    }
    ...
    if (message.sqdName !== undefined) {
      writer.uint32(346).string(message.sqdName);
    }
    return writer;
  },
...
export const NodeServiceCreateRequest: MessageFns<NodeServiceCreateRequest> = {
  encode(message: NodeServiceCreateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.orgId !== "") {
    ...
    if (message.launcher !== undefined) {
      NodeLauncher.encode(message.launcher, writer.uint32(34).fork()).join();
    }
    for (const v of message.newValues) {
      NewImagePropertyValue.encode(v!, writer.uint32(42).fork()).join();
    }
    for (const v of message.addRules) {
      FirewallRule.encode(v!, writer.uint32(50).fork()).join();
    }
    if (message.tags !== undefined) {
      Tags.encode(message.tags, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceCreateRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NewImagePropertyValue: MessageFns<NewImagePropertyValue> = {
  encode(message: NewImagePropertyValue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NewImagePropertyValue {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceCreateResponse: MessageFns<NodeServiceCreateResponse> = {
  encode(message: NodeServiceCreateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceCreateResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceGetRequest: MessageFns<NodeServiceGetRequest> = {
  encode(message: NodeServiceGetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceGetRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceGetResponse: MessageFns<NodeServiceGetResponse> = {
  encode(message: NodeServiceGetResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceGetResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceListRequest: MessageFns<NodeServiceListRequest> = {
  encode(message: NodeServiceListRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.search !== undefined) {
      NodeSearch.encode(message.search, writer.uint32(34).fork()).join();
    }
    for (const v of message.sort) {
      NodeSort.encode(v!, writer.uint32(42).fork()).join();
    }
    for (const v of message.protocolIds) {
      writer.uint32(50).string(v!);
    }
    for (const v of message.versionKeys) {
      ProtocolVersionKey.encode(v!, writer.uint32(58).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceListRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeSearch: MessageFns<NodeSearch> = {
  encode(message: NodeSearch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeSearch {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeSort: MessageFns<NodeSort> = {
  encode(message: NodeSort, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.field !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeSort {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceListResponse: MessageFns<NodeServiceListResponse> = {
  encode(message: NodeServiceListResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.nodes) {
      Node.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.total !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceListResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceReportStatusRequest: MessageFns<NodeServiceReportStatusRequest> = {
  encode(message: NodeServiceReportStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    if (message.configId !== "") {
    ...
    if (message.status !== undefined) {
      NodeStatus.encode(message.status, writer.uint32(26).fork()).join();
    }
    if (message.p2pAddress !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceReportStatusRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceReportStatusResponse: MessageFns<NodeServiceReportStatusResponse> = {
  encode(_: NodeServiceReportStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceReportStatusResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceReportErrorRequest: MessageFns<NodeServiceReportErrorRequest> = {
  encode(message: NodeServiceReportErrorRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    if (message.createdBy !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceReportErrorRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceReportErrorResponse: MessageFns<NodeServiceReportErrorResponse> = {
  encode(message: NodeServiceReportErrorResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.reportId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceReportErrorResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceUpdateConfigRequest: MessageFns<NodeServiceUpdateConfigRequest> = {
  encode(message: NodeServiceUpdateConfigRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    ...
    for (const v of message.newValues) {
      NewImagePropertyValue.encode(v!, writer.uint32(50).fork()).join();
    }
    if (message.newFirewall !== undefined) {
      FirewallConfig.encode(message.newFirewall, writer.uint32(58).fork()).join();
    }
    if (message.updateTags !== undefined) {
      UpdateTags.encode(message.updateTags, writer.uint32(66).fork()).join();
    }
    if (message.cost !== undefined) {
      BillingAmount.encode(message.cost, writer.uint32(74).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceUpdateConfigRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceUpdateConfigResponse: MessageFns<NodeServiceUpdateConfigResponse> = {
  encode(_: NodeServiceUpdateConfigResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceUpdateConfigResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceUpgradeImageRequest: MessageFns<NodeServiceUpgradeImageRequest> = {
  encode(message: NodeServiceUpgradeImageRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceUpgradeImageRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceUpgradeImageResponse: MessageFns<NodeServiceUpgradeImageResponse> = {
  encode(_: NodeServiceUpgradeImageResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceUpgradeImageResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceStartRequest: MessageFns<NodeServiceStartRequest> = {
  encode(message: NodeServiceStartRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceStartRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceStartResponse: MessageFns<NodeServiceStartResponse> = {
  encode(_: NodeServiceStartResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceStartResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceStopRequest: MessageFns<NodeServiceStopRequest> = {
  encode(message: NodeServiceStopRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceStopRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceStopResponse: MessageFns<NodeServiceStopResponse> = {
  encode(_: NodeServiceStopResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceStopResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceRestartRequest: MessageFns<NodeServiceRestartRequest> = {
  encode(message: NodeServiceRestartRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceRestartRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceRestartResponse: MessageFns<NodeServiceRestartResponse> = {
  encode(_: NodeServiceRestartResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceRestartResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceDeleteRequest: MessageFns<NodeServiceDeleteRequest> = {
  encode(message: NodeServiceDeleteRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nodeId !== "") {
      writer.uint32(10).string(message.nodeId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceDeleteRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceDeleteResponse: MessageFns<NodeServiceDeleteResponse> = {
  encode(_: NodeServiceDeleteResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): NodeServiceDeleteResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const NodeServiceDefinition = {
  ...
  methods: {
    ...
    create: {
      name: "Create",
      requestType: NodeServiceCreateRequest as typeof NodeServiceCreateRequest,
      requestStream: false,
      responseType: NodeServiceCreateResponse as typeof NodeServiceCreateResponse,
    ...
    get: {
      name: "Get",
      requestType: NodeServiceGetRequest as typeof NodeServiceGetRequest,
      requestStream: false,
      responseType: NodeServiceGetResponse as typeof NodeServiceGetResponse,
      responseStream: false,
      options: {},
    },
    ...
    list: {
      name: "List",
      requestType: NodeServiceListRequest as typeof NodeServiceListRequest,
      requestStream: false,
      responseType: NodeServiceListResponse as typeof NodeServiceListResponse,
      responseStream: false,
      options: {},
    },
    /** Report the current status of a node. */
    reportStatus: {
      name: "ReportStatus",
      requestType: NodeServiceReportStatusRequest as typeof NodeServiceReportStatusRequest,
      requestStream: false,
      responseType: NodeServiceReportStatusResponse as typeof NodeServiceReportStatusResponse,
      responseStream: false,
      options: {},
    },
    ...
    reportError: {
      name: "ReportError",
      requestType: NodeServiceReportErrorRequest as typeof NodeServiceReportErrorRequest,
      requestStream: false,
      responseType: NodeServiceReportErrorResponse as typeof NodeServiceReportErrorResponse,
      responseStream: false,
      options: {},
    },
    ...
    updateConfig: {
      name: "UpdateConfig",
      requestType: NodeServiceUpdateConfigRequest as typeof NodeServiceUpdateConfigRequest,
      requestStream: false,
      responseType: NodeServiceUpdateConfigResponse as typeof NodeServiceUpdateConfigResponse,
      responseStream: false,
      options: {},
    },
    ...
    upgradeImage: {
      name: "UpgradeImage",
      requestType: NodeServiceUpgradeImageRequest as typeof NodeServiceUpgradeImageRequest,
      requestStream: false,
      responseType: NodeServiceUpgradeImageResponse as typeof NodeServiceUpgradeImageResponse,
      responseStream: false,
      options: {},
    },
    /** Start a node. */
    start: {
      name: "Start",
      requestType: NodeServiceStartRequest as typeof NodeServiceStartRequest,
      requestStream: false,
      responseType: NodeServiceStartResponse as typeof NodeServiceStartResponse,
      responseStream: false,
      options: {},
    },
    /** Stop a node. */
    stop: {
      name: "Stop",
      requestType: NodeServiceStopRequest as typeof NodeServiceStopRequest,
      requestStream: false,
      responseType: NodeServiceStopResponse as typeof NodeServiceStopResponse,
      responseStream: false,
      options: {},
    },
    /** Restart a node. */
    restart: {
      name: "Restart",
      requestType: NodeServiceRestartRequest as typeof NodeServiceRestartRequest,
      requestStream: false,
      responseType: NodeServiceRestartResponse as typeof NodeServiceRestartResponse,
      responseStream: false,
      options: {},
    },
    /** Delete a node. */
    delete: {
      name: "Delete",
      requestType: NodeServiceDeleteRequest as typeof NodeServiceDeleteRequest,
      requestStream: false,
      responseType: NodeServiceDeleteResponse as typeof NodeServiceDeleteResponse,
      responseStream: false,
      options: {},
    },
