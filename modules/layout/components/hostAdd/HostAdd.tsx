            ...
            <>
              ...
              <DrawerContent>
                <div>
                  ...
                  >
                    Please follow the steps below to complete the creation
                    process.
                  </p>
                  ...
                  <section css={styles.step}>
                    ...
                    <p css={styles.stepDescription}>
                      If you don’t have it already, you can download BlockJoy
                      from this link.
                    </p>
                  ...
                  <section css={styles.step}>
                    ...
                    <p css={styles.stepDescription}>
                      Your key can be found below, please store it in a safe
                      place as necessary.
                    </p>
                  ...
                  <section css={styles.step}>
                    ...
                    <p css={styles.stepDescription}>
                      Once your key has been set up in BlockJoy, you will be
                      able to view your provisioned host via the Hosts tab.
                    </p>
                    <Button size="small" style="outline">
                      View Hosts
                    </Button>
