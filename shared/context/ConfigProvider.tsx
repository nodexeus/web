  ...
  useEffect(() => {
    async function loadConfig() {
      ...
      try {
        ...
        console.log(
          'ConfigProvider: publicRuntimeConfig available:',
        ...
        try {
          console.log(
            'ConfigProvider: Attempting to fetch runtime config from API',
          );
          ...
          if (!response.ok) {
            console.warn(
              `ConfigProvider: API returned ${response.status}: ${response.statusText}`,
            );
            throw new Error(
          ...
          console.warn(
            'ConfigProvider: Failed to load runtime config from API:',
            apiError,
          );
          ...
          if (hasWindowConfig) {
            console.log(
              'ConfigProvider: Falling back to window runtime config',
            );
        ...
        console.error(
          'ConfigProvider: All runtime config sources failed:',
          error,
        );
        ...
        console.log(
          'ConfigProvider: Using fallback config from next.config.js:',
          {
            ...fallbackConfig,
